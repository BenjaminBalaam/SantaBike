...
const button = preload("res://Scenes/Level Button Scoreboard Template.tscn")
var newButton
var text
var screenSize
...
func _process(delta):
	...
	text.rect_position.x = (screenSize.x - 859) / 2
	text.rect_position.y = screenSize.y * 0.916666667
